...
import sty from "./PlasmicChatListItem.module.css"; // plasmic-import: uqUraSuaqp/css

export const PlasmicChatListItem__VariantProps = new Array();

export const PlasmicChatListItem__ArgProps = new Array("roomName");

export const defaultChatListItem__Args = {};

function PlasmicChatListItem__RenderFunc(props) {
  const { variants, overrides, forNode } = props;
  const args = Object.assign({}, defaultChatListItem__Args, props.args);
  const $props = args;
