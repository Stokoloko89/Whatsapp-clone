...
import sty from "./PlasmicButton.module.css"; // plasmic-import: JejkMCPIcT0/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: wD8IUIla8n5/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: I76wj2c3l3y/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___5PdA)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__ycqDs)}
                role={"img"}
              />
            ),
