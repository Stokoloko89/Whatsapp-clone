...
import sty from "./PlasmicAvatar.module.css"; // plasmic-import: vXSjmOQDKr/css
        ...
        <div
          ...
          className={classNames(projectcss.all, sty.freeBox, {
            ...
            [sty.freeBoxisEmpty_size__45]:
              hasVariant(variants, "isEmpty", "isEmpty") &&
              hasVariant(variants, "size", "_45"),
            [sty.freeBoxsize__60_isEmpty]:
              hasVariant(variants, "isEmpty", "isEmpty") &&
              hasVariant(variants, "size", "_60")
          })}
        >
          {(hasVariant(variants, "isEmpty", "isEmpty") ? true : false)
            ? p.renderPlasmicSlot({
                defaultContents: "A",
